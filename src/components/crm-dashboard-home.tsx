      ...
      <div className="mx-auto max-w-6xl space-y-8">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          <div className="rounded-3xl border border-white/10 bg-[#111111] p-6">
            ...
            <div className="text-sm font-medium text-blue-400">+15% this week</div>
          </div>
          <div className="rounded-3xl border border-white/10 bg-[#111111] p-6">
            <div className="mb-2 text-sm font-semibold tracking-wider text-gray-500 uppercase">
              Active Cases
          ...
          <div className="rounded-3xl border border-white/10 bg-[#111111] p-6">
            ...
            <div className="text-sm font-medium text-gray-400">Next: 2:00 PM</div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-3xl border border-white/10 bg-[#111111]">
            ...
            <div className="space-y-6 p-6">
              <div className="flex">
                <div className="w-20 pt-0.5 text-sm text-gray-500">10:00 AM</div>
              ...
              <div className="flex">
                ...
                <div className="relative flex-1 border-l border-blue-500/50 pl-4">
                  ...
                  <div className="font-medium text-white">Consult: Marcus Chen</div>
