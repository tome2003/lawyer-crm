  ...
  return (
    <div className="bg-paper-bright flex min-h-screen flex-col items-center justify-center px-4 py-24">
      <div className="border-ink/10 bg-paper max-w-xl rounded-3xl border p-10 text-center shadow-sm">
        ...
        <Link
          href="/"
          className="bg-ink text-paper-bright mt-8 inline-flex w-full items-center justify-center rounded-xl py-3.5 text-sm font-semibold tracking-wide transition-opacity hover:opacity-92 sm:w-auto sm:px-10"
        >
          {t("cta")}
        </Link>
      </div>
